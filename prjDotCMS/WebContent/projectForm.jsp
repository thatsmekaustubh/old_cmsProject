...
<form action="projectWriteCtrl" enctype="multipart/form-data" method="post" onsubmit="return check(this)" id="submitContentForm" name="join">
   ...
   <div id="Start" class="contentTab first">
	...
	<div class="group">
		...
		<dd id="firstNameFieldInput" class="formFieldInput">
			<input type="text" class="text" name="id" id="firstName" maxlength="255" value="" />			
		</dd>
	</div><!-- end .group -->
